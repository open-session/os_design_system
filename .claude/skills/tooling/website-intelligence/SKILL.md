...
This skill performs comprehensive website analysis and generates two structured Markdown deliverables:

1. **`site-map-report.md`** - Holistic site overview with architecture, SEO, and performance insights
2. **`page-diagrams.md`** - Visual page structure diagrams using ASCII wireframes and Mermaid flowcharts
