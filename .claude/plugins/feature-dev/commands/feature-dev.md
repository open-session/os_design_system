...
- **Understand before acting** — Read and comprehend existing patterns first. Understand your project's design tokens and component patterns.
...
**For any project**: Always check:
- Design token files (CSS variables, theme.css, etc.)
- Existing UI component directories
- `.claude/CLAUDE.md` — Project-specific guidelines and design system reference
...
4. Follow project conventions (defined in CLAUDE.md):
   - Use CSS variables, not hardcoded colors
   - Follow the project's design system patterns
   - Build on accessible component libraries when available
...
1. Launch 3 reviewer agents:
   ...
   - **Project Conventions** — Does it match the design system?
...
Reviewers check against project CLAUDE.md guidelines:
- Design token usage (CSS variables, not hardcoded)
- Accessibility (focus states, contrast, screen readers)
- UI conventions (borders, spacing, component patterns)
...
*A designer-friendly workflow for systematic feature development*
