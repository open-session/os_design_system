...
export function ChatResponse({
  ...
  return (
    <div {...devProps('ChatResponse')} className="flex flex-col h-full">
      {/* Sticky Header with tabs and actions */}
      <div className="sticky top-0 z-10 bg-bg-primary backdrop-blur-sm border-b border-border-secondary">
          ...
          {activeTab === 'resources' && (
            <div className="space-y-8">
              ...
              {sources.length === 0 && images.length === 0 && assetTypes.length === 0 && (
                <p className="text-fg-tertiary text-sm">No resources available</p>
              )}
            </div>
          )}
        </div>
