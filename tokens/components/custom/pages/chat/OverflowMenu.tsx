...
import { Bookmark, FolderPlus, Pencil01 as Pencil, Trash01, DotsHorizontal as MoreHorizontal, File01 as FileText, FileCode01 as FileCode, FileDownload01 as FileDown } from '@untitledui-pro/icons/line';
...
export function OverflowMenu({
  ...
  return (
    <div {...devProps('OverflowMenu')} className="relative" ref={menuRef}>
      <button
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-bg-secondary rounded-xl border border-border-primary shadow-xl z-50 overflow-hidden">
          {/* Thread info header */}
          <div className="px-4 py-3 border-b border-border-primary">
            <p className="text-sm font-medium text-fg-primary truncate">
              {threadTitle}
            </p>
            <div className="flex items-center gap-4 mt-1 text-xs text-fg-tertiary">
