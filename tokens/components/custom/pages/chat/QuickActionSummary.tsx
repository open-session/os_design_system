...
// UUI fallback: MagicWand01 → Zap (null-mapped, consistent with T2a)
...
export function QuickActionSummary({ 
  ...
  return (
    <div {...devProps('QuickActionSummary')} className="bg-bg-secondary rounded-2xl overflow-hidden max-w-[85%]">
      {/* Header Row - Platform + Quick Action Type */}
      <div className="px-4 py-3 border-b border-border-secondary">
        <div className="flex items-center gap-3">
          {/* Platform Icon */}
          <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-bg-tertiary text-fg-secondary">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {brandVoice?.hasVoiceContext && (
                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-bg-brand-primary/10 text-fg-brand-primary">
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          {/* Goal Tag */}
          <span className="inline-flex items-center px-2 py-1 rounded-md bg-bg-tertiary text-xs font-medium text-fg-secondary">
            {formData.goalLabel}
          </span>
          ...
          {formData.contentSubtypeLabels.map((subtype, idx) => (
            <span 
              key={idx}
              className="inline-flex items-center px-2 py-1 rounded-md bg-bg-tertiary text-xs text-fg-tertiary"
            >
              {subtype}
            </span>
          ))}
          ...
          {isExpanded && formData.outputPreferences && (
            ...
            >
              <div className="pt-2 border-t border-border-secondary">
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-fg-tertiary">
