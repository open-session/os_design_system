...
export function AddBrainResourceModal({
  ...
  return (
    <Modal {...devProps('AddBrainResourceModal')} isOpen={isOpen} onClose={handleClose} title={isEditMode ? "Edit Resource" : "Add Resource"} size="md">
      <div className="space-y-4">
        <div>
          <label htmlFor="resource-name" className="block text-sm font-medium text-fg-primary mb-1.5">
            Name <span className="text-fg-error-primary">*</span>
          </label>
          <input
            id="resource-name"
            type="text"
        ...
        <div>
          <label htmlFor="resource-url" className="block text-sm font-medium text-fg-primary mb-1.5">
          ...
          />
          {error && (
            <p className="mt-1 text-sm text-fg-error-primary" role="alert">
              {error}
            </p>
          )}
        </div>
        ...
        {/* Category (optional) */}
        <div>
          <label htmlFor="brain-resource-category" className="block text-sm font-medium text-fg-primary mb-1.5">
            Category <span className="text-fg-tertiary">(optional)</span>
          </label>
          <CategoryInput
                ...
                <button
                  ...
                  className={`
                    ...
                    ${selectedIcon === iconName
                      ? 'bg-bg-brand-primary border-border-brand-solid text-fg-brand-primary'
                      : 'bg-bg-tertiary border-transparent text-fg-tertiary hover:border-border-brand-solid hover:text-fg-primary'
                    }
                  `}
                >
