...
export function ProjectHeader({ project, onUpdate, onDelete }: ProjectHeaderProps) {
  ...
  return (
    <div {...devProps('ProjectHeader')} className="mb-6">
      {/* Back link */}
      <Link
        href="/projects"
        className="
          ...
          {isEditingName ? (
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1.5 rounded-md text-fg-brand-primary hover:bg-bg-tertiary"
              >
              ...
              <button
                ...
                className="p-1.5 rounded-md text-fg-tertiary hover:bg-bg-tertiary"
              >
            ...
            <h1
              className="
                text-2xl font-bold text-fg-primary
                cursor-pointer
      ...
      <div className="mt-2">
        {isEditingDescription ? (
          ...
          >
            {project.description || (
              <span className="text-fg-quaternary italic">
                Add a description...
              </span>
            )}
          </p>
