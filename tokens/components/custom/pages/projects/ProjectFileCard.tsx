...
import { Download01, LinkExternal01, XClose } from '@untitledui-pro/icons/line';
    ...
    >
      ...
      >
        ...
        <div className="space-y-1">
          <p className="text-xs font-medium text-fg-primary truncate" title={displayName}>
            {truncatedName}
          </p>
          {file.file_size && (
