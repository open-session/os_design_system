...
export function ProfileForm({
  ...
  if (isLoading) {
    return (
      <div {...devProps('ProfileForm')} className="max-w-3xl animate-pulse">
        {/* Header skeleton */}
        <div className="flex items-start justify-between gap-4 pb-5 border-b border-border-secondary">
        ...
        {/* Field skeletons */}
        {[...Array(5)].map((_, i) => (
          <div key={i} className="flex flex-col lg:flex-row lg:items-start gap-4 lg:gap-8 py-5 border-b border-border-secondary">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              ...
              className="
                ...
                bg-bg-primary
                text-bg-brand-solid
                focus:ring-1 focus:ring-brand focus:shadow-focus-ring focus:ring-offset-0
              "
            />
