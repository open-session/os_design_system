...
// UUI fallback: Unlink → XClose (no Unlink/disconnect icon in UUI)
...
// Google icon SVG
const GoogleIcon = () => (
  <svg {...devProps('GoogleIcon')} viewBox="0 0 24 24" className="w-5 h-5" fill="none">
...
// Apple icon SVG
const AppleIcon = () => (
  <svg {...devProps('AppleIcon')} viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
...
export function EmailForm() {
  ...
  return (
    <div {...devProps('EmailForm')} className="max-w-3xl">
      <SettingsSectionHeader
        title={t('title')}
      ...
      {/* Single Sign-On */}
      <div className="py-5 border-b border-border-secondary">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {emailItem.isPrimary && (
                      <span className="
                        ...
                        bg-bg-brand-primary
                        rounded-full
                        text-xs font-medium text-fg-brand-primary
                      ">
                        Primary
                      </span>
                    )}
                  ...
                  <p className="text-sm text-fg-tertiary">
                    {emailItem.isVerified ? (
                      ...
                      <span className="text-fg-warning-primary">
      ...
      <div className="mt-8 pt-8 border-t border-border-secondary">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between py-3 border-b border-border-secondary">
            <div>
              <p className="text-sm font-medium text-fg-secondary">Product updates</p>
              <p className="text-sm text-fg-tertiary">News about product and feature updates.</p>
            </div>
            <Toggle
          ...
          <div className="flex items-center justify-between py-3 border-b border-border-secondary">
            <div>
              <p className="text-sm font-medium text-fg-secondary">Security alerts</p>
              <p className="text-sm text-fg-tertiary">Important security notifications.</p>
            </div>
            <Toggle
          ...
          <div className="flex items-center justify-between py-3 border-b border-border-secondary">
            <div>
              <p className="text-sm font-medium text-fg-secondary">Marketing emails</p>
              <p className="text-sm text-fg-tertiary">Tips, tutorials, and promotional content.</p>
            </div>
            <Toggle
          ...
          <div className="flex items-center justify-between py-3">
            <div>
              <p className="text-sm font-medium text-fg-secondary">Weekly digest</p>
              <p className="text-sm text-fg-tertiary">A weekly summary of your activity.</p>
            </div>
            <Toggle
