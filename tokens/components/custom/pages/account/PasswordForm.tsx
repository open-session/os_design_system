...
// UUI fallback: Smartphone → Phone01 (closest mobile device icon)
...
function PasswordInput({
  ...
  return (
    <div {...devProps('PasswordInput')} className="relative">
      <input
...
export function PasswordForm() {
  ...
  return (
    <div {...devProps('PasswordForm')} className="max-w-3xl">
      <SettingsSectionHeader
        title={t('title')}
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      text-sm
                      ${isMet ? 'text-fg-success-primary' : 'text-fg-tertiary'}
                    `}
                  >
                    {isMet ? (
      ...
      <SettingsField label={t('confirmPassword')} required>
        <div className="space-y-2">
          ...
          {confirmPassword && !passwordsMatch && (
            <p className="text-sm text-fg-error-primary">
              Passwords do not match
            </p>
          )}
          {passwordsMatch && confirmPassword && (
            <p className="text-sm text-fg-success-primary flex items-center gap-1">
              <Check className="w-4 h-4" />
              Passwords match
            </p>
          )}
      ...
      <div className="mt-8 pt-8 border-t border-border-secondary">
        <div className="flex items-start gap-4 mb-6">
          <div className="
            ...
            flex-shrink-0
          ">
            <Shield01 className="w-5 h-5 text-fg-tertiary" />
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="
                ...
                flex items-center justify-center
              ">
                <Phone01 className="w-5 h-5 text-fg-tertiary" />
              </div>
              <div>
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-3">
                <div className="
                  ...
                  flex items-center justify-center
                ">
                  <Key01 className="w-5 h-5 text-fg-tertiary" />
                </div>
                <div>
                  <p className="text-sm font-medium text-fg-primary">
                    Backup codes
              ...
              ">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {backupCodes.map((code) => (
                    ...
                    >
                      ...
                      >
                        {copiedCode === code ? (
                          <Check className="w-3 h-3 text-fg-success-primary" />
                        ) : (
                ...
                <button
                  className="
                    ...
                    hover:text-fg-brand-primary-hover
                    transition-colors
                  "
                >
                  Generate new codes
