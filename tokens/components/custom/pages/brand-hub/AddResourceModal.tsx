...
export function AddResourceModal({
  ...
  return (
    <Modal {...devProps('AddResourceModal')} isOpen={isOpen} onClose={handleClose} title={isEditMode ? "Edit Resource" : "Add Resource"} size="md">
      <div className="space-y-4">
        ...
        {/* Category (optional) */}
        <div>
          <label htmlFor="resource-category" className="block text-sm font-medium text-fg-primary mb-1.5">
