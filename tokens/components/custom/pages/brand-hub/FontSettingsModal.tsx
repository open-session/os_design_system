...
import { Bold01, Type01, Upload01 } from '@untitledui-pro/icons/line';
...
export function FontSettingsModal({ isOpen, onClose }: FontSettingsModalProps) {
  ...
  const renderFontPreview = (font: BrandFont) => {
    const meta = font.metadata as BrandFontMetadata;
    return (
      <div className="w-12 h-12 rounded-lg bg-bg-primary border border-border-primary flex items-center justify-center">
        <span
          className="text-lg font-medium text-fg-primary"
