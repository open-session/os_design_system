...
// UUI fallback: StarOff → Star01 (no StarOff in UUI; visual context preserved)
// UUI fallback: Figma → LinkExternal01 (no Figma brand icon in UUI free tier)
...
export function GuidelinesSettingsModal({ isOpen, onClose }: GuidelinesSettingsModalProps) {
  ...
  const getTypeIcon = (type: BrandGuidelineType) => {
    switch (type) {
      case 'figma':
        return <LinkExternal01 className="w-4 h-4" />;
      case 'pdf':
      case 'pptx':
      case 'ppt':
  ...
  const renderGuidelinePreview = (guideline: BrandGuideline) => (
    <div className="w-12 h-12 rounded-lg bg-bg-primary border border-border-primary flex items-center justify-center text-fg-tertiary">
  ...
  return (
    <>
      <BrandHubSettingsModal
        {...devProps('GuidelinesSettingsModal')}
        isOpen={isOpen}
        onClose={() => {
          resetForm();
          onClose();
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-fg-secondary">Set as primary guideline</span>
            </label>
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-border-primary">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-sm font-medium bg-bg-brand-primary hover:bg-bg-brand-secondary text-fg-brand-primary transition-colors disabled:opacity-50"
              >
          ...
          <div className="space-y-8">
            ...
            >
              {figmaGuidelines.length === 0 ? (
                <EmptyState
                  icon={<LinkExternal01 className="w-6 h-6" />}
            ...
            >
              {linkGuidelines.length === 0 ? (
                <EmptyState
                  ...
                  description="LinkIcon to Notion, Google Docs, or other resources"
                />
              ) : (
                <div className="space-y-2">
