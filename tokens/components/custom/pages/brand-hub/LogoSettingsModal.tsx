...
import { Image01 as ImageIcon, SearchLg, Trash01, Palette } from '@untitledui-pro/icons/line';
...
export function LogoSettingsModal({ isOpen, onClose }: LogoSettingsModalProps) {
  ...
  const renderLogoPreview = (logo: BrandLogo) => (
    <div className="w-12 h-12 rounded-lg bg-bg-primary border border-border-primary flex items-center justify-center overflow-hidden">
      {logo.publicUrl ? (
          ...
          <div className="space-y-6">
            ...
            <FormField label="Category">
              <label className="flex items-center gap-2">
                ...
                />
                <span className="text-sm text-fg-secondary">This is an accessory logo</span>
              </label>
            </FormField>
