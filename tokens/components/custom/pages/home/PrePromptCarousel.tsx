...
import { ChevronLeft, ChevronRight, Image01, LayoutGrid01 as LayoutGrid, MessageSquare01 as MessageSquare, Palette, Type01 as Type, Zap, Announcement01 as Megaphone, Lightbulb02 as Lightbulb, Target01 as Target } from '@untitledui-pro/icons/line';
...
export function PrePromptCarousel({ onPromptSubmit }: PrePromptCarouselProps) {
  ...
  return (
    <div {...devProps('PrePromptCarousel')} className="w-full max-w-3xl mx-auto px-4">
