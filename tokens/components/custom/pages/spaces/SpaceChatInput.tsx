...
import { Microphone01, Send01, ShoppingBag01 } from '@untitledui-pro/icons/line';
import { devProps } from '@/lib/utils/dev-props';
import { ModelId } from '@/lib/ai/providers';
import { useAttachments } from '@/hooks/useAttachments';
import { useVoiceRecognition } from '@/hooks/useVoiceRecognition';
import { useChatContext } from '@/lib/chat-context';
import { AttachmentPreview, DragOverlay } from '@/components/custom/pages/chat/AttachmentPreview';
...
export function SpaceChatInput({
  ...
  return (
    <div {...devProps('SpaceChatInput')} className="fixed bottom-0 left-0 right-0 z-30 lg:pl-[56px]">
          ...
          >
            ...
            <div className="relative">
              <textarea
                ...
                className="w-full px-4 py-4 bg-transparent text-fg-primary placeholder:text-fg-tertiary resize-none focus:outline-hidden min-h-[60px] max-h-[150px]"
                rows={1}
            ...
            <div className="flex flex-wrap items-center justify-between px-4 py-3 border-t border-border-primary gap-2 sm:gap-4">
              {/* Left side - Plus menu, Active settings */}
