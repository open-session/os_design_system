...
import { CanvasHeader } from '@/components/custom/shared/overlays/CanvasHeader';
import { CanvasContent } from '@/components/custom/shared/overlays/CanvasContent';
import { ResizableDivider } from '@/components/custom/shared/overlays/ResizableDivider';
    ...
    <AnimatePresence mode="wait">
      {isCanvasOpen && (
        <>
          ...
          <motion.div
            key="canvas-panel"
            {...devProps('CanvasPanel')}
            className={`fixed top-14 right-0 bottom-0 z-40 flex flex-col bg-bg-primary border-l border-border-primary shadow-2xl ${className}`}
            style={{
              width: getPanelWidth(),
              ...themeStyles,
            }}
