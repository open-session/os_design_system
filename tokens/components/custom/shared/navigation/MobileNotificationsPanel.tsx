...
import { AlertCircle, ArrowLeft, Bell01, CheckCircle, InfoCircle as Info, Settings01, Trash01, CheckDone01 as CheckCheck } from '@untitledui-pro/icons/line';
...
export function MobileNotificationsPanel() {
  ...
  return (
    <motion.div
      {...devProps('MobileNotificationsPanel')}
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border-secondary bg-bg-secondary">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <h2 className="text-lg font-semibold text-fg-primary">Notifications</h2>
            {unreadCount > 0 && (
              <span className="
                px-2 py-0.5
                bg-aperol
        ...
        {notifications.length > 0 ? (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {!notification.read && (
                        <span className="w-2.5 h-2.5 rounded-full bg-aperol flex-shrink-0 mt-1.5" />
                      )}
                    </div>
                    <p className="text-sm text-fg-tertiary mt-0.5 line-clamp-2">
                      {notification.message}
                    </p>
                    <p className="text-xs text-fg-quaternary mt-1.5">
          ...
          <div className="flex flex-col items-center justify-center h-full px-8 text-center">
            <div className="
              ...
              flex items-center justify-center
            ">
              <Bell01 className="w-8 h-8 text-fg-quaternary" />
            </div>
            <h3 className="text-lg font-semibold text-fg-primary mb-1">
              No notifications
            </h3>
            <p className="text-sm text-fg-tertiary max-w-[240px]">
