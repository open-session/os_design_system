...
export function NavigationDrawer({ isOpen, item, onClose, railRef }: NavigationDrawerProps) {
  ...
  const handleQuickAction = useCallback((actionId: string, prompt: string) => {
    ...
    if (formType) {
      ...
      triggerChatReset();
      router.push(`/chat?action=${formType}`);
    } else {
            ...
            <div className="px-3">
              <motion.div variants={fadeInUp} className="mb-2">
                <div className="flex items-center justify-between px-2 pt-3 pb-2">
                  <h3 className="text-base font-semibold text-fg-primary">Chats</h3>
                  <Link
                    href="/chats"
                    onClick={onClose}
                    className="text-sm text-fg-brand-primary hover:underline flex items-center gap-1"
                  >
                    View all
                ...
                {chatHistory.length > 0 ? (
                  chatHistory.slice(0, 8).map((chat, index) => (
                    <motion.button
                      ...
                      className="w-full text-left px-3.5 py-3 rounded-lg text-base text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors flex items-center gap-2"
                    >
                      <span className="truncate">{chat.title}</span>
                    </motion.button>
                  ))
                ) : (
                  <p className="text-sm text-fg-quaternary px-3 py-2">
                    No recent chats yet
                  </p>
                )}
              </div>
        ...
        return (
          ...
          >
            <div className="px-3">
              <motion.div variants={fadeInUp} className="mb-2">
                <div className="flex items-center justify-between px-2 pt-3 pb-2">
                  <h3 className="text-base font-semibold text-fg-primary">Projects</h3>
                  <Link
                    href="/projects"
                    onClick={onClose}
                    className="text-sm text-fg-brand-primary hover:underline flex items-center gap-1"
                  ...
                  projects.slice(0, 8).map((project, index) => (
                    <motion.div key={project.id} variants={fadeInUp} custom={index}>
                      <Link
                        ...
                        onClick={onClose}
                        className="w-full flex items-center gap-2 px-3.5 py-3 rounded-lg text-base text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors"
                      >
                        <div
              ...
              <motion.div variants={fadeInUp} className="mt-3 pt-3 border-t border-border-secondary">
                <Link
                  href="/projects"
                  onClick={onClose}
                  className="w-full flex items-center gap-2 px-3.5 py-3 rounded-lg text-base text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors"
        ...
        return (
          ...
          >
            ...
            <div className="px-2 mb-2">
              <motion.div variants={fadeInUp} className="mb-2">
                <h3 className="text-base font-semibold text-fg-primary px-2 pt-3 pb-2">Spaces</h3>
              </motion.div>

              <motion.button
                variants={fadeInUp}
                className="w-full flex items-center gap-2 px-2.5 py-2.5 rounded-md text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors mb-1 text-base"
              >
                <File01 className="w-5 h-5" />
                <span>Templates</span>
              </motion.button>

              <motion.button
                variants={fadeInUp}
                className="w-full flex items-center gap-2 px-2.5 py-2.5 rounded-md text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors mb-3 text-base"
              >
                <FolderPlus className="w-5 h-5" />
                <span>Create new Space</span>
              </motion.button>

              <motion.div variants={fadeInUp} className="border-t border-border-secondary pt-2">
                <div className="px-3 py-1 text-xs text-fg-tertiary mb-2">My Spaces</div>
                {!spacesLoaded ? (
                  <div className="px-3 py-2 text-sm text-fg-quaternary">
                    Loading...
                  </div>
                ) : userSpaces.length === 0 ? (
                  <div className="px-3 py-2 text-sm text-fg-quaternary">
                    ...
                    return (
                      ...
                      >
                        <Link
                          ...
                          `}
                        >
                          <LayoutGrid01 className={`w-5 h-5 ${isSpaceActive ? 'text-fg-brand-primary' : ''}`} />
      ...
      case 'Home':
        return (
          ...
          >
            <div className="px-3">
              <motion.div variants={fadeInUp} className="mb-2">
                <h3 className="text-base font-semibold text-fg-primary px-2 pt-3 pb-2">Home</h3>
              </motion.div>

              {/* Quick Actions section - First */}
              <motion.div variants={fadeInUp} className="mb-4">
                <div className="flex items-center justify-between mb-2 px-2">
                  <h4 className="text-xs font-medium text-fg-tertiary uppercase tracking-wide">Quick actions</h4>
                </div>
                  ...
                  {quickActions.map((action, index) => {
                    return (
                      <motion.button
                        ...
                        className="w-full text-left px-3.5 py-2.5 rounded-md text-base text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors flex items-center gap-2 group"
                      >
              ...
              {/* Projects section */}
              <motion.div variants={fadeInUp} className="mb-4 pt-3 border-t border-border-secondary">
                <div className="flex items-center justify-between mb-2 px-2">
                  <h4 className="text-xs font-medium text-fg-tertiary uppercase tracking-wide">Projects</h4>
                  <Link
                    href="/projects"
                    onClick={onClose}
                    className="text-xs text-fg-brand-primary hover:underline flex items-center gap-0.5"
                  >
                    View all
                ...
                <div className="space-y-1">
                  {projects.length > 0 ? (
                    ...
                    <p className="text-sm text-fg-quaternary px-3 py-1">
                      No projects yet
                    </p>
                  )}
                </div>
              ...
              <motion.div variants={fadeInUp} className="pt-3 border-t border-border-secondary">
                <div className="flex items-center justify-between mb-2 px-2">
                  <h4 className="text-xs font-medium text-fg-tertiary uppercase tracking-wide">Chats</h4>
                  <Link
                    href="/chats"
                    onClick={onClose}
                    className="text-xs text-fg-brand-primary hover:underline flex items-center gap-0.5"
      ...
      case 'Brand':
        ...
        return (
          ...
          >
            ...
            <div className="px-2">
              <motion.div variants={fadeInUp} className="mb-2">
                <h3 className="text-base font-semibold text-fg-primary px-2 pt-3 pb-2">Brand</h3>
              </motion.div>
              ...
              {isOnSubpage && (
                <motion.div variants={fadeInUp} className="mt-3 pt-3 border-t border-border-secondary">
                  <Link
                    href="/brand-hub"
                    className="w-full flex items-center justify-center gap-2 px-2.5 py-2.5 rounded-md text-fg-tertiary hover:bg-bg-tertiary hover:text-fg-primary transition-colors text-base"
                  >
                    View All Assets
                  </Link>
                </motion.div>
      ...
      case 'Brain':
        ...
        return (
          ...
          >
            ...
            <div className="px-2">
              <motion.div variants={fadeInUp} className="mb-2">
                <h3 className="text-base font-semibold text-fg-primary px-2 pt-3 pb-2">Brain</h3>
              </motion.div>
      ...
      case 'Resources':
        return (
          ...
          >
            ...
            <div className="px-2">
              <motion.div variants={fadeInUp} className="mb-2">
                <h3 className="text-base font-semibold text-fg-primary px-2 pt-3 pb-2">Resources</h3>
              </motion.div>

              <motion.div variants={fadeInUp} className="text-base text-fg-tertiary p-2">
    ...
    <AnimatePresence mode="wait">
      {isOpen && item && (
        <motion.div
          key={item}
          ref={drawerRef}
          {...devProps('NavigationDrawer')}
          data-navigation-drawer
          className="hidden lg:block fixed z-[175] w-[256px] bg-bg-secondary border-r border-border-secondary shadow-lg overflow-y-auto"
          style={{
            top: `${position.top}px`,
