...
export function MobileHeader({ onBrandClick }: MobileHeaderProps) {
  ...
  return (
    <>
      <header {...devProps('MobileHeader')} className="lg:hidden fixed top-0 left-0 right-0 z-[160] h-14 bg-bg-secondary backdrop-blur-sm border-b border-border-secondary">
        <div className="flex items-center justify-between h-full px-3">
          ...
          <div className="flex items-center gap-1">
            ...
            <motion.button
              ...
              className="p-2 ml-1 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-md hover:bg-bg-tertiary transition-colors"
            ...
            >
              <div className="w-6 h-6 relative flex items-center justify-center">
                ...
                <motion.span
                  className="absolute w-5 h-0.5 bg-fg-primary rounded-full origin-center"
                  initial={false}
                  animate={{
                ...
                <motion.span
                  className="absolute w-5 h-0.5 bg-fg-primary rounded-full"
                  initial={false}
                  animate={{
