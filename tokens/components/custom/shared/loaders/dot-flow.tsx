...
export const ThinkingDotFlow = ({ className }: { className?: string }) => {
  ...
  return (
    <div {...devProps('ThinkingDotFlow')} className="contents">
      <DotFlow
        items={items}
        className={className}
        dotColor="bg-brand-500/20 [&.active]:bg-brand-500"
      />
    </div>
  );
};
...
export const DotLoaderOnly = ({ className }: { className?: string }) => {
  ...
  return (
    <div {...devProps('DotLoaderOnly')} className={className}>
      <DotLoader
        ...
        dotClassName="bg-brand-500/20 [&.active]:bg-brand-500"
      />
    </div>
  );
};
...
export const DotFlow = ({ items, className, dotColor }: DotFlowProps) => {
  ...
  return (
    <div {...devProps('DotFlow')} className={`flex items-center gap-2 ${className || ''}`}>
      <DotLoader
