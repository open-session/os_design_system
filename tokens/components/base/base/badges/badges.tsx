...
import { XClose as CloseX } from "@untitledui-pro/icons/line";
import { Dot } from "@/components/base/foundations/dot-icon";
...
export const Badge = <T extends BadgeTypes>(props: BadgeProps<T>) => {
    ...
    return <span {...devProps('Badge')} className={cx(colors.common, sizes[type][size], colors.styles[color].root, props.className)}>{children}</span>;
};
...
export const BadgeWithDot = <T extends BadgeTypes>(props: BadgeWithDotProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeWithDot')} className={cx(colors.common, sizes[type][size], colors.styles[color].root, className)}>
...
export const BadgeWithIcon = <T extends BadgeTypes>(props: BadgeWithIconProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeWithIcon')} className={cx(colors.common, sizes[type][size][icon], colors.styles[color].root, className)}>
...
export const BadgeWithFlag = <T extends BadgeTypes>(props: BadgeWithFlagProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeWithFlag')} className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
...
export const BadgeWithImage = <T extends BadgeTypes>(props: BadgeWithImageProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeWithImage')} className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
...
export const BadgeWithButton = <T extends BadgeTypes>(props: BadgeWithButtonProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeWithButton')} className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
            {children}
            <button
                type="button"
...
export const BadgeIcon = <T extends BadgeTypes>(props: BadgeIconProps<T>) => {
    ...
    return (
        <span {...devProps('BadgeIcon')} className={cx(colors.common, sizes[type][size], colors.styles[color].root)}>
