...
import type { TextFieldProps } from "@/components/base/base/input/input";
            ...
            {({ isDisabled, isInvalid, isRequired }) => (
                <>
                    ...
                    <div
                        ...
                        className={cx(
                            "group relative flex h-max w-full flex-row justify-center rounded-lg bg-primary transition-all duration-micro ease-linear",
