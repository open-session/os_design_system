...
export const NativeSelect = ({ label, hint, options, className, selectClassName, size = "md", ...props }: NativeSelectProps) => {
    ...
    return (
        <div {...devProps('NativeSelect')} className={cx("w-full in-data-input-wrapper:w-max", className)}>
            {label && (
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        "appearance-none rounded-lg bg-primary font-medium text-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-micro ease-linear ring-inset placeholder:text-fg-quaternary focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50",
