...
// Note: no eslint-disable needed for bos-local/require-dev-props here — this
// file exports a context, types, and a sizes lookup table; no React component
// renders DOM in this module. Pre-commit's bash heuristic detects this comment
// to avoid a false positive on the capitalised exports.
