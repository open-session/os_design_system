...
const MultiSelectFooter = ({ size = "sm", onReset, onSelectAll, className }: MultiSelectFooterProps) => {
    ...
    return (
        <div {...devProps('MultiSelectFooter')} className={cx("flex items-center justify-between border-t border-secondary p-3", className)}>
...
const MultiSelectEmptyState = ({
    ...
    <div {...devProps('MultiSelectEmptyState')} className={cx("flex flex-col items-center gap-3 px-4 py-4", className)}>
...
const MultiSelectRoot = ({
    ...
    return (
        <SelectContext.Provider value={{ size }}>
            <div {...devProps('MultiSelectRoot')} className={cx("flex flex-col gap-1.5", className)}>
                {label && (
                ...
                <AriaDialogTrigger>
                    <AriaButton
                        ...
                        className={(state) =>
                            cx(
                                "relative flex w-full cursor-pointer items-center rounded-lg bg-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-micro ease-linear ring-inset",
                    ...
                    <AriaPopover
                        ...
                        className={(state) =>
                            cx(
                                ...
                                state.isEntering &&
                                    "duration-micro ease-out animate-in fade-in placement-top:slide-in-from-bottom-0.5 placement-bottom:slide-in-from-top-0.5",
                                state.isExiting &&
                                    "duration-micro ease-in animate-out fade-out placement-top:slide-out-to-bottom-0.5 placement-bottom:slide-out-to-top-0.5",
                                popoverClassName,
                            )
                        }
                    >
