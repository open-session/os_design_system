        ...
        <AriaTextArea
            ...
            className={(state) =>
                cx(
                    ...
                    state.isFocused && !state.isDisabled && "ring-1 ring-brand shadow-focus-ring-elevated",
                    state.isDisabled && "cursor-not-allowed opacity-50",
                    state.isInvalid && "ring-error_subtle",
                    state.isInvalid && state.isFocused && "ring-1 ring-error shadow-focus-ring-error-elevated",
