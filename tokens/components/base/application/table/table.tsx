                ...
                <AriaGroup className="flex items-center gap-1">
                    ...
                    {tooltip && (
                        <Tooltip title={tooltip} placement="top">
                            <TooltipTrigger className="cursor-pointer text-fg-quaternary transition duration-micro ease-linear hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover">
