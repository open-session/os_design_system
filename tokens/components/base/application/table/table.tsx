...
export const TableRowActionsDropdown = () => (
    <Dropdown.Root {...devProps('TableRowActionsDropdown')}>
        <Dropdown.DotsButton />
...
const TableCardRoot = ({ children, className, size = "md", ...props }: HTMLAttributes<HTMLDivElement> & { size?: "sm" | "md" }) => {
    return (
        <TableContext.Provider value={{ size }}>
            <div {...devProps('TableCardRoot')} {...props} className={cx("overflow-hidden rounded-xl bg-primary shadow-xs ring-1 ring-secondary", className)}>
                {children}
            </div>
...
const TableRoot = ({ className, size = "md", ...props }: TableRootProps) => {
    ...
    return (
        <TableContext.Provider value={{ size: context?.size ?? size }}>
            <div {...devProps('TableRoot')} className="overflow-x-auto">
                ...
                <AriaGroup className="flex items-center gap-1">
                    ...
                    {tooltip && (
                        <Tooltip title={tooltip} placement="top">
                            <TooltipTrigger className="cursor-pointer text-fg-quaternary transition duration-micro ease-motion-out hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover">
