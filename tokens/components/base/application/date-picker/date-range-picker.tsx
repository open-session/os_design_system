...
import { Button, type ButtonProps } from "@/components/base/base/buttons/button";
...
export const DateRangePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, size = "sm", ...props }: DateRangePickerProps) => {
    ...
    return (
        <AriaDateRangePicker {...devProps('DateRangePicker')} aria-label="Date range picker" shouldCloseOnSelect={false} {...props} value={value} onChange={setValue}>
            <AriaGroup>
