...
export const RangePresetButton = ({ value, className, children, ...props }: RangePresetButtonProps) => {
    ...
    return (
        <button
            ...
            {...props}
            className={cx(
                "cursor-pointer rounded-md px-3 py-2 text-left text-sm font-medium outline-focus-ring transition duration-micro ease-motion-out focus-visible:outline-2 focus-visible:outline-offset-2",
