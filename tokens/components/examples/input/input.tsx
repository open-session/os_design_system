    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled, isInvalid }) =>
                cx(
                    "relative flex w-full flex-row place-content-center place-items-center rounded-lg bg-primary shadow-xs ring-1 ring-primary transition-shadow duration-micro ease-motion-out ring-inset",

                    isFocusWithin && !isDisabled && "ring-1 ring-brand shadow-focus-ring-elevated",
                    ...
                    isInvalid && isFocusWithin && "ring-1 ring-error shadow-focus-ring-error-elevated",
                    isFocusWithin && "group-invalid:ring-1 group-invalid:ring-error group-invalid:shadow-focus-ring-error-elevated",
        ...
        >
            ...
            {tooltip && !isInvalid && (
                <Tooltip title={tooltip} placement="top">
                    <TooltipTrigger
                        className={cx(
                            "absolute cursor-pointer text-fg-quaternary transition duration-standard hover:text-fg-quaternary_hover focus:text-fg-quaternary_hover",
...
export const Input = ({
    ...
    return (
        <TextField {...devProps('Input')} aria-label={!label ? placeholder : undefined} {...props} className={className}>
